...
//
// Write your code here 👇
let secondResult = (myFavoriteNumber*otherNumber);
...
// Write your code here 👇
let numPetsOwned = (1);
let sunglassesOwned = (4);
let lastMealRating = (10);
let lastGroceryTrip = (8);
console.log(numPetsOwned);
console.log(sunglassesOwned);
console.log(lastMealRating);
console.log(lastGroceryTrip);
